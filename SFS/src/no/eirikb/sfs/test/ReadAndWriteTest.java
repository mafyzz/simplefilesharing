...
public class ReadAndWriteTest {
    ...
    public static void main(String[] args) {
        ...
        //File file = new File("/users/eirikb/test");
      ...
      //    ShareFileReader r1 = new ShareFileReader(readShare.getShare(), file);
        ...
        ShareFileReader r2 = new ShareFileReader(ShareUtility.cropShare(readShare, split + 1, split * 2), file);
     ...
     //    ShareFileWriter w1 = new ShareFileWriter(writeShare.getShare(), writeFile);
        ...
        ShareFileWriter w2 = new ShareFileWriter(ShareUtility.cropShare(writeShare, split + 1, split * 2), writeFile);
